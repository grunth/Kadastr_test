 ...
 * 
 * <p>Java class for tEntitySpatialLandInp complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="tEntitySpatialLandInp"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="SpatialElement" type="{}tSpatialElementLandInp" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "tEntitySpatialLandInp", propOrder = {
    "spatialElement"
})
@XmlSeeAlso({
    TEntitySpatialBordersLand.class
})
public class TEntitySpatialLandInp {

    @XmlElement(name = "SpatialElement", required = true)
    protected List<TSpatialElementLandInp> spatialElement;
     ...
     * {@link TSpatialElementLandInp }
     * 
     * 
     */
    public List<TSpatialElementLandInp> getSpatialElement() {
        if (spatialElement == null) {
            spatialElement = new ArrayList<TSpatialElementLandInp>();
        }
