 ...
 * 
 * <p>Java class for tEntitySpatialLandOut complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="tEntitySpatialLandOut"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="SpatialElement" type="{}tSpatialElementLandOut" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "tEntitySpatialLandOut", propOrder = {
    "spatialElement"
})
public class TEntitySpatialLandOut {

    @XmlElement(name = "SpatialElement", required = true)
    protected List<TSpatialElementLandOut> spatialElement;
     ...
     * {@link TSpatialElementLandOut }
     * 
     * 
     */
    public List<TSpatialElementLandOut> getSpatialElement() {
        if (spatialElement == null) {
            spatialElement = new ArrayList<TSpatialElementLandOut>();
        }
